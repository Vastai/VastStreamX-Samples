...
parse.add_argument("--gt_dir", type=str, default="/home/simplew/dataset/face/lfw_mtcnnpy_160", help="src image folder")
parse.add_argument("--gt_pairs_path", type=str, default="/home/simplew/dataset/face/pairs.txt", help="https://github.com/davidsandberg/facenet/blob/master/data/pairs.txt")
parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/vamp_result", help="vamp output folder")
