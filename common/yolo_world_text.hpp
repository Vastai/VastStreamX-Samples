...
#include "utils.hpp"
namespace vsx {
class YoloWorldText : public ModelNLP {
 public:
  YoloWorldText(const std::string& model_prefix, const std::string& vdsp_config,
