...
int main(int argc, char** argv) {
  ...
  // std::vector<float> voxel_sizes{0.16, 0.16, 4};
  // std::vector<float> coors_ranges{0, -39.68, -3, 69.12, 39.68, 1};
  ...
  for (uint32_t i = 0; i < instance; i++) {
    ...
    models.push_back(std::make_shared<vsx::Detection3D>(
        ...
        max_points_num, shuffle_enabled, normalize_enabled, 480, 480, 480,
        480));
  }
