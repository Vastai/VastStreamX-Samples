...
#include "common/yolo_world_image.hpp"
...
int main(int argc, char** argv) {
  ...
  std::vector<std::shared_ptr<vsx::YoloWorldImage>> models;
  ...
  for (uint32_t i = 0; i < instance; i++) {
    ...
    models.push_back(std::make_shared<vsx::YoloWorldImage>(
  ...
  vsx::ModelProfiler<vsx::YoloWorldImage> profiler(config, models);
