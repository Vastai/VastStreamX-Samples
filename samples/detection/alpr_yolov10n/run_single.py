...
parse.add_argument(
    "--file_path",
    type=str,
    default="/home/aico/Downloads/double_yellow.jpg",
    help="img path",
)
parse.add_argument(
    "--model_prefix_path",
    type=str,
    default="/home/aico/Downloads/docker/yolov10n/deploy_weights/yolov10n_alpr/mod",
    help="model info",
)
parse.add_argument(
    "--vdsp_params_info",
    type=str,
    default="/home/aico/Downloads/docker/yolov10n/official-yolov10n-vdsp_params.json",
    help="vdsp op info",
)
parse.add_argument(
    "--label_txt",
    type=str,
    default="/home/aico/Downloads/docker/yolov10n/label.txt",
    help="label txt",
)
...
def save_result(image_path, result, save_dir):
    ...
    for box in result:
        ...
        y = (
            int(int(box["bbox"][1])) - 15
            if int(int(box["bbox"][1])) - 15 > 15
            else int(int(box["bbox"][1])) + 15
        )
        cv.putText(
            origin_img,
            text,
...
class Detector:
    ...
    def run_batch(
        self, images: Iterable[Union[str, np.ndarray]]
