...
int main(int argc, char** argv) {
  ...
  std::vector<std::shared_ptr<vsx::Dinov2Model>> models;
  ...
  for (uint32_t i = 0; i < instance; i++) {
    ...
    models.push_back(std::make_shared<vsx::Dinov2Model>(
  ...
  vsx::ModelProfiler<vsx::Dinov2Model> profiler(config, models, warmup_times);
