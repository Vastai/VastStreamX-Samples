...
int main(int argc, char** argv) {
  ...
  std::vector<std::shared_ptr<vsx::MobileVit>> models;
  ...
  for (uint32_t i = 0; i < instance; i++) {
    ...
    models.push_back(std::make_shared<vsx::MobileVit>(
  ...
  vsx::ModelProfiler<vsx::MobileVit> profiler(config, models, warmup_times);
