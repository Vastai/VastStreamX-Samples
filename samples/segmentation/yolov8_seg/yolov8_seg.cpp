...
#include "common/yolov8_segmenter.hpp"
...
cmdline::parser ArgumentParser(int argc, char **argv) {
  ...
  args.add<std::string>(
      ...
      "yolov8m-seg-int8-percentile-1_3_640_640-vacc-pipeline/mod");
  ...
  args.add<std::string>("vdsp_params", '\0', "vdsp preprocess parameter file",
                        false, "../data/configs/yolov8seg_bgr888.json");
...
std::vector<cv::Vec3b> colors = {
    {255, 85, 0},    {255, 170, 0},  {255, 0, 85},    {0, 255, 0},
    {0, 0, 0},       {255, 0, 170},  {85, 255, 0},    {170, 255, 0},
    {0, 255, 85},    {0, 255, 170},  {0, 0, 255},     {85, 0, 255},
    {170, 0, 255},   {0, 85, 255},   {0, 170, 255},   {255, 255, 0},
    {255, 255, 170}, {255, 0, 255},  {255, 85, 255},  {255, 170, 255},
    {0, 255, 255},   {85, 255, 255}, {170, 255, 255}, {255, 255, 85},
};
...
int main(int argc, char **argv) {
  ...
  vsx::Yolov8Segmenter segmenter(args.get<std::string>("model_prefix"),
  ...
  if (args.get<std::string>("dataset_filelist").empty()) {
    ...
    for (auto &file : filelist) {
      ...
      if (tensors.size() > 0) {
        ...
        output_map["classes"] = tensors[0];
        output_map["scores"] = tensors[1];
        output_map["boxes"] = tensors[2];
        output_map["masks"] = tensors[3];
        output_map["num"] = tensors[4];
