...
def argument_parser():
    ...
    parser.add_argument(
        "-m",
        "--model_prefix",
        default="/opt/vastai/vaststreamx/data/models/isnet-int8-kl_divergence-1_3_320_320-vacc/mod",
    ...
    parser.add_argument(
        "--vdsp_params",
        default="../../../../data/configs/isnet_bgr888.json",
...
if __name__ == "__main__":
    ...
    if args.dataset_filelist == "":
        ...
        output = np.clip(np.floor(0.5 + output * 255), 0, 255).astype(np.uint8)
